<?php
  ...
  // 2.1a - 18 Jan 2006
  //  - Allows toUTM to use a specific zone rather than the normal one!
  ...
  class LatLng {
     ...
     */
    function toUTMRef($latZoneFake = '', $lngZoneFake = '') {
  ...
  class UTMRef {
    ...
    function toString() {
      return $this->lngZone . $this->latZone . " " .
             intval($this->easting) . " " . intval($this->northing);
    }
